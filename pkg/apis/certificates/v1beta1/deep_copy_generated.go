...
func init() {
	if err := api.Scheme.AddGeneratedDeepCopyFuncs(
		...
		DeepCopy_v1beta1_CertificateSigningRequestApproval,
...
func DeepCopy_v1beta1_CertificateSigningRequest(in CertificateSigningRequest, out *CertificateSigningRequest, c *conversion.Cloner) error {
	...
	if err := DeepCopy_v1beta1_CertificateSigningRequestApproval(in.Approve, &out.Approve, c); err != nil {
		return err
	}
	return nil
}

func DeepCopy_v1beta1_CertificateSigningRequestApproval(in CertificateSigningRequestApproval, out *CertificateSigningRequestApproval, c *conversion.Cloner) error {
	out.State = in.State
