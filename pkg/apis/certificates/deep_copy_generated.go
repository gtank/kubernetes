...
func DeepCopy_certificates_CertificateSigningRequestSpec(in CertificateSigningRequestSpec, out *CertificateSigningRequestSpec, c *conversion.Cloner) error {
	...
	if err := DeepCopy_certificates_Subject(in.Subject, &out.Subject, c); err != nil {
		return err
	}
	if in.Hostnames != nil {
...
func DeepCopy_certificates_Subject(in Subject, out *Subject, c *conversion.Cloner) error {
	if in.Country != nil {
