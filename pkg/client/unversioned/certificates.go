...
func (c *CertificatesClient) CertificateSigningRequets(namespace string) CertificateSigningRequestInterface {
	return newCertificateSigningRequets(c, namespace)
}
