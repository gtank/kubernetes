...
KUBE_API_VERSIONS="v1,autoscaling/v1,batch/v1,extensions/v1beta1,certificates/v1beta1" "${KUBE_OUTPUT_HOSTBIN}/kube-apiserver" \
...
DEFAULT_GROUP_VERSIONS="v1 autoscaling/v1 batch/v1 extensions/v1beta1 certificates/v1beta1"
