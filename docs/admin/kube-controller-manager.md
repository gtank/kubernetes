...
```
      ...
      --cluster-signing-cert-file="/var/lib/kubernetes/ca/ca.pem": Filename containing a PEM-encoded X509 CA certificate used to issue cluster-scoped certificates
      --cluster-signing-key-file="/var/lib/kubernetes/ca/ca.key": Filename containing a PEM-encoded RSA or ECDSA private key used to sign cluster-scoped certificates
